...
public class BitComputersArchitecture65CE02 extends BitComputersArchitecture {
	private final Machine machine;

	private BitComputersVM65CE02 vm;
	...
	public BitComputersArchitecture65CE02(Machine machine) {
	...
	public boolean initialize() {
		// Set up new VM here
		vm = new BitComputersVM65CE02(machine);
	...
	public void runSynchronized() {
		if (syncCall != null) {
			...
			CPU65CE02 cpu = vm.machine.getCpu();
			((CPU65CE02State) cpu.getCpuState()).pc = ((CPU65CE02State) cpu.getCpuState()).lastPc;
			cpu.step();
	...
	public void load(NBTTagCompound nbt) {
		...
		// Restore CPU
		if (nbt.hasKey("cpu")) {
			CPU65CE02 mCPU = vm.machine.getCpu();
			CPU65CE02State cpuState = (CPU65CE02State) mCPU.getCpuState();
	...
	private static NBTTagCompound getNbtTagCompound(CPU65CE02 mCPU) {
		CPU65CE02State cpuState = (CPU65CE02State) mCPU.getCpuState();
